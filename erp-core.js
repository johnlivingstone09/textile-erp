...
(function () {
  ...
  const NAV = [
    ...
    ["Sell", [
      ...
      ["dispatch", "dispatch.html", "Dispatch & invoices"],
  ...
  function derive() {
    ...
    const invoiced = db.invoices.reduce((s, i) => s + i.metres * i.rate * (1 + i.gst / 100), 0);
  ...
  const ERP = {
    ...
    shell, kpis, table, badge, statusBadge, bar, modal, confirm, form, readForm, crud, toast,
