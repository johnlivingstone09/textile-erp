...
window.ERP_SEED = (function () {
  ...
  const customers = [
    { id:"C-001", name:"ABC Textiles",        city:"Tiruppur",     gstin:"33AABCA1111C1Z5", contact:"Mohan",   phone:"+91 98430 11111", terms:"30 days", credit:2500000, outstanding:845000 },
    { id:"C-002", name:"Vante Noir",          city:"Chennai",      gstin:"33AACCV2222D1Z2", contact:"Anitha",  phone:"+91 98840 22222", terms:"45 days", credit:1500000, outstanding:312000 },
    { id:"C-003", name:"Karur Home Linen",    city:"Karur",        gstin:"33AAECK3333E1Z9", contact:"Bala",    phone:"+91 99940 33333", terms:"30 days", credit:2000000, outstanding:560000 },
    { id:"C-004", name:"Erode Fabrics LLP",   city:"Erode",        gstin:"33AAFFE4444F1Z1", contact:"Kumar",   phone:"+91 94430 44444", terms:"On invoice", credit:800000, outstanding:0 },
    { id:"C-005", name:"Coimbatore Knits",    city:"Coimbatore",   gstin:"33AAGCC5555G1Z7", contact:"Sridhar", phone:"+91 90030 55555", terms:"60 days", credit:3000000, outstanding:1180000 },
    { id:"C-006", name:"Madurai Uniforms",    city:"Madurai",      gstin:"33AAHCM6666H1Z4", contact:"Fatima",  phone:"+91 96770 66666", terms:"30 days", credit:600000, outstanding:96000 }
  ];
  ...
  /* ---------- fabric masters ---------- */
  const fabrics = [
    { id:"F-001", name:"Poplin 40x40",     warp:"40s", weft:"40s", gsm:110, width:60, weave:"Plain",  comp:"100% Cotton", finish:"Bleached",  shrink:"2.5%", rate:96 },
    { id:"F-002", name:"Twill 20x20",      warp:"20s", weft:"20s", gsm:180, width:58, weave:"Twill",  comp:"65/35 PC",    finish:"Dyed",      shrink:"3.0%", rate:128 },
    { id:"F-003", name:"Voile 60x60",      warp:"60s", weft:"60s", gsm:78,  width:44, weave:"Plain",  comp:"100% Cotton", finish:"Mercerised",shrink:"2.0%", rate:104 },
    { id:"F-004", name:"Cambric 30x30",    warp:"30s", weft:"30s", gsm:120, width:63, weave:"Plain",  comp:"100% Cotton", finish:"Dyed",      shrink:"2.8%", rate:88 },
    { id:"F-005", name:"Oxford 2/40x20",   warp:"2/40s",weft:"20s",gsm:165, width:58, weave:"Oxford", comp:"100% Cotton", finish:"Soft",      shrink:"3.2%", rate:142 },
    { id:"F-006", name:"Rayon Challis",    warp:"30s", weft:"30s", gsm:95,  width:56, weave:"Plain",  comp:"100% Viscose",finish:"Printed",   shrink:"3.5%", rate:112 }
  ];
  ...
  const quotations = [
    { id:"QT-0416", date:"2026-08-20", customer:"C-005", fabric:"F-002", qty:30000, rate:126, valid:"2026-09-20", status:"Sent" },
    { id:"QT-0417", date:"2026-08-23", customer:"C-003", fabric:"F-001", qty:18000, rate:97,  valid:"2026-09-23", status:"Under discussion" },
    { id:"QT-0418", date:"2026-08-25", customer:"C-006", fabric:"F-004", qty:5000,  rate:90,  valid:"2026-09-25", status:"Sent" }
  ];
  ...
  const invoices = [
    { id:"IN-2026-0311", date:"2026-08-20", so:"SO-1027", customer:"C-002", metres:5820, rate:142, gst:5, paid:514000, status:"Part paid" },
    { id:"IN-2026-0312", date:"2026-08-22", so:"SO-1025", customer:"C-001", metres:9000, rate:96,  gst:5, paid:0,      status:"Unpaid" },
    { id:"IN-2026-0313", date:"2026-08-24", so:"SO-1026", customer:"C-003", metres:8200, rate:88,  gst:5, paid:200000, status:"Part paid" },
    { id:"IN-2026-0308", date:"2026-08-08", so:"SO-1027", customer:"C-002", metres:2000, rate:142, gst:5, paid:298200, status:"Paid" }
  ];
  ...
  const modulesList = [
    ...
    { key:"dispatch",     name:"Dispatch & invoices",  group:"Sell" },
  ...
  const roles = [
    ...
    { id:"R-06", name:"Accounts",  note:"Money, orders and reports",
      perms:["dashboard","sales","dispatch","finance","purchase","hr","reports"] }
  ];
